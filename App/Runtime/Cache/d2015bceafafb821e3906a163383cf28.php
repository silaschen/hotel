...
if(!isNaN('<?php echo ($eq); ?>')){
  ...
  <div class="box box-solid">
    <div class="box-header with-border">
      ...
      <a href="<?php echo U('HotelSys/hotellist');?>" class="btn btn-default pull-right">返回</a>
    </div><!-- /.box-header -->
    <div class="box-body">
      <form method="GET" action="<?php echo U('HotelSys/roomlist');?>" id='search' style="margin-bottom:15px;">
       ...
       <div class="col-xs-4 col-md-3">
        ...
        <div class="col-xs-8 col-md-3">
          <div class="input-group">
            ...
            <?php if($_GET['word'] != '' OR $_GET['id'] != '' OR $_GET['status'] != ''): ?><a title='清除条件' class="input-group-addon" href="<?php echo U('HotelSys/roomlist',array('hid'=>I('hid')));?>"><i class="fa fa-remove"></i></a><?php endif; ?>
          </div>
        </div>
      </div>
      </form>
