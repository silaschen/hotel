...
if(!isNaN('<?php echo ($eq); ?>')){
  ...
  <div class="box box-solid">
    ...
    <div class="box-body">
      <form method="GET" action="<?php echo U('HotelAdm/roomlist');?>" id='search' style="margin-bottom:15px;">
      <div class="row">
        ...
        <div class="col-xs-8 col-md-3">
          <div class="input-group">
            ...
            <?php if($_GET['word'] != '' OR $_GET['id'] != '' OR $_GET['status'] != ''): ?><a title='清除条件' class="input-group-addon" href="<?php echo U('HotelAdm/roomlist');?>"><i class="fa fa-remove"></i></a><?php endif; ?>
          </div>
        </div>
      </div>
      </form>
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td><?php if($vo["cover"] != ''): ?><img onclick="show('<?php echo ($vo['cover']); ?>')" src="<?php echo ($vo["cover"]); ?>" class="img-responsive" height="40" width="40"><?php endif; ?></td>
          ...
          <td>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="javascript:HotelInfo(<?php echo ($vo["id"]); ?>)">详情</a></li>
                <li><a href="<?php echo U('HotelAdm/addroom',array('id'=>$vo['id']));?>">修改</a></li>
                <li class="divider"></li>
    ...
    <div class="box-footer clearfix">
      ...
      <a href="<?php echo U('HotelAdm/addroom');?>" class="btn btn-success pull-right">添加房型</a>
    </div> 
  </div>
<!--   图片 -->
