    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">酒店数量</span>
          <span class="info-box-number"><a href="<?php echo U('AreaAdm/hotellist');?>"><?php echo mkcount('hotel_list',array('a1'=>$_SESSION['a1'],'a2'=>$_SESSION['a2']),false);?></a></span>
