...
if(!isNaN('<?php echo ($eq); ?>')){
  ...
  <div class="box box-solid">
    ...
    <div class="box-body">
       <form method="GET" action="<?php echo U('AreaAdm/hotellist');?>" id='search' style="margin-bottom:15px;">
      <div class="row">
       ...
       <div class="col-xs-4 col-md-2">
        ...
        <div class="col-xs-8 col-md-3">
          <div class="input-group">
            ...
            <?php if($_GET['word'] != '' OR $_GET['status'] != '' OR $_GET['a1'] > '0' OR $_GET['a2'] > '0' OR $_GET['a3'] > '0' OR $_GET['id'] != ''): ?><a title='清除条件' class="input-group-addon" href="<?php echo U('AreaAdm/hotellist');?>"><i class="fa fa-remove"></i></a><?php endif; ?>
          </div>
        </div>
      </div>
      </form>
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td><a href="<?php echo U('AreaAdm/roomlist',array('hid'=>$vo['id']));?>" class="badge bg-blue"><?php echo ($vo["roomnum"]); ?></a></td>
          ...
          <td>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="<?php echo U('AreaAdm/addhotel',array('id'=>$vo['id']));?>">修改</a></li>
                <li class="divider"></li>
    ...
    <div class="box-footer clearfix">
      ...
      <a href="<?php echo U('AreaAdm/addhotel');?>" class="btn btn-success pull-right">添加酒店</a>
    </div> 
  </div>
<!--   图片 -->
...
$(function(){
  ...
  AreaInit(true);
<?php if($_SESSION['a1'] > '0'): ?>$("select[name='a1']").val(<?php echo $_SESSION['a1'];?>);
GetArea('a1','a2',true);<?php endif; ?>
<?php if($_SESSION['a2'] > '0'): ?>$("select[name='a2']").val(<?php echo $_SESSION['a2'];?>);
