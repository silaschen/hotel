...
function codeAddress() {
  ...
  <div class="box box-solid">
    <div class="box-header with-border">
      <h3 class="box-title">添加/编辑酒店</h3><a href="<?php echo U('HotelSys/hotellist');?>" class='btn btn-default btn-xs pull-right'>返回列表</a>
    </div><!-- /.box-header -->
    <div class="box-body">
         ...
         <div class="row">
            <div class="col-xs-4 col-md-4">
              <select name='a1' class='form-control' onchange="GetArea('a1','a2',true);codeAddress();">
              </select>
            </div>
            <div class="col-xs-4 col-md-4" style="padding:0 5px;">
              <select name='a2' class='form-control' onchange="GetArea('a2','a3',true);codeAddress();"></select>
            </div>
            <div class="col-xs-4 col-md-4">
...
function SaveHotel(){
  ...
  if(vr('title') == ''){
    ...
    $(".savehotel").addClass('disabled');
    loading2("操作中...");
    $.post(location.href,$("#form").serializeArray(),function(data){
        alert(data.msg);
        if (data.ret == 1) {
          location.href = "<?php echo U('HotelSys/hotellist');?>";
        }else{
          loading2("",0);
        }
    },'JSON');
