...
if(!isNaN('<?php echo ($eq); ?>')){
  ...
  <div class="box box-solid">
    ...
    <div class="box-body">
       <form method="GET" action="<?php echo U('HotelSys/AreaUserList');?>" id='search' style="margin-bottom:15px;">
      <div class="row">
       ...
       <div class="col-xs-4 col-md-2">
        ...
        <div class="col-xs-8 col-md-3">
          <div class="input-group">
            <input name="word" type='text' class='form-control' value="<?php echo I('word');?>" placeholder='账号/关键词搜索..'>
            <span class="input-group-addon" onclick="$('#search').submit();"><i class="fa fa-search"></i></span>
            <?php if($_GET['word'] != '' OR $_GET['a1'] > '0' OR $_GET['a2'] > '0' OR $_GET['status'] != '' ): ?><a title='清除条件' class="input-group-addon" href="<?php echo U('HotelSys/AreaUserList');?>"><i class="fa fa-remove"></i></a><?php endif; ?>
          </div>
        </div>
      </div>
      </form>
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td><?php echo ($vo["a1"]); ?></td>
          <td><?php echo ($vo["a2"]); ?></td>
          ...
          <td>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="<?php echo U('HotelSys/AddAreaUser',array('id'=>$vo['id']));?>">修改</a></li>
                <li class="divider"></li>
    ...
    <div class="box-footer clearfix">
      ...
      <a href="<?php echo U('HotelSys/AddAreaUser');?>" class="btn btn-success pull-right">添加账号</a>
    </div> 
  </div>
